...
(function() {
    ...
    if (shift === 'F2F') {
      ...
      if (isKinder) {
        ...
        timeline = [
          ...
          { is_break: true, time: '04:10 PM – 04:20 PM', minutes: '10 min.', label: 'DISMISSAL' }
        ];
      }
    } else { // ODL - 2ND SHIFT
      timeline = [
  ...
  function getFacultyTimeline(shiftsSet) {
    ...
    if (hasF2F) {
      ...
      timeline.push({ is_break: false, time: '09:00 AM – 10:00 AM', minutes: '60 min.', slot_id: 'f2f_s2' });
    ...
    if (hasODL1) {
      ...
      timeline.push({ is_break: true, time: '01:40 PM – 01:50 PM', minutes: '10 min.', label: 'TRANSITION' });
      timeline.push({ is_break: false, time: '01:50 PM – 02:50 PM', minutes: '60 min.', slot_id: 'odl1_s2' });
      timeline.push({ is_break: true, time: '02:50 PM – 03:10 PM', minutes: '20 min.', label: 'TRANSITION AND SALAH BREAK' });
      timeline.push({ is_break: false, time: '03:10 PM – 04:10 PM', minutes: '60 min.', slot_id: 'odl1_s3' });
    }
    ...
    if (hasODL2) {
      ...
      timeline.push({ is_break: true, time: '04:10 PM – 04:20 PM', minutes: '10 min.', label: 'TRANSITION' });
      timeline.push({ is_break: false, time: '04:20 PM – 05:20 PM', minutes: '60 min.', slot_id: 'odl2_s2' });
    ...
    if (timeline.length === 0) {
      timeline = [
        ...
        { is_break: false, time: '09:00 AM – 10:00 AM', minutes: '60 min.', slot_id: 'f2f_s2' },
        { is_break: true, time: '10:00 AM – 10:25 AM', minutes: '25 min.', label: 'RECESS' },
        ...
        { is_break: true, time: '01:40 PM – 01:50 PM', minutes: '10 min.', label: 'TRANSITION' },
        { is_break: false, time: '01:50 PM – 02:50 PM', minutes: '60 min.', slot_id: 'odl1_s2' },
        { is_break: true, time: '02:50 PM – 03:10 PM', minutes: '20 min.', label: 'TRANSITION AND SALAH BREAK' },
        { is_break: false, time: '03:10 PM – 04:10 PM', minutes: '60 min.', slot_id: 'odl2_s1' },
        { is_break: true, time: '04:10 PM – 04:20 PM', minutes: '10 min.', label: 'TRANSITION' },
        { is_break: false, time: '04:20 PM – 05:20 PM', minutes: '60 min.', slot_id: 'odl2_s2' },
        { is_break: true, time: '05:20 PM – 05:30 PM', minutes: '10 min.', label: 'TRANSITION' },
        ...
        if (row.is_break) {
          ...
          EXAM_DATES.forEach(d => {
            const matches = tExams.filter(e => {
              ...
              if (e.duration_minutes >= 90 && (row.time.includes('08:00 AM') || row.time.includes('09:00 AM') || row.time.includes('12:40 PM') || row.time.includes('01:50 PM') || row.time.includes('03:10 PM') || row.time.includes('04:20 PM'))) {
                return true;
              }
              return false;
            });
