...
def get_f2f_slots(sec, count, opt=0):
    ...
    if g == 'Kinder 1':
        if count == 1:
            return [{"start": "12:40 PM", "end": "1:40 PM", "time": "12:40 PM – 1:40 PM"}]
        else:
            return [
                {"start": "12:40 PM", "end": "1:40 PM", "time": "12:40 PM – 1:40 PM"},
                {"start": "1:50 PM", "end": "2:50 PM", "time": "1:50 PM – 2:50 PM"}
            ]
    elif g == 'Kinder 2':
        if count == 1:
            return [{"start": "7:40 AM", "end": "8:40 AM", "time": "7:40 AM – 8:40 AM"}]
        else:
            return [
                {"start": "7:40 AM", "end": "8:40 AM", "time": "7:40 AM – 8:40 AM"},
                {"start": "9:10 AM", "end": "10:10 AM", "time": "9:10 AM – 10:10 AM"}
            ]
    else: # Grades 1-12 F2F (Full window: 7:40 AM – 3:00 PM)
        # Recess 9:45-10:00 AM, Lunch & Salah 11:30 AM-12:40 PM, Departure 3:00 PM
        if count == 1:
            return [{"start": "7:40 AM", "end": "8:40 AM", "time": "7:40 AM – 8:40 AM"}]
        elif count == 2:
            return [
                {"start": "7:40 AM", "end": "8:40 AM", "time": "7:40 AM – 8:40 AM"},
                {"start": "8:40 AM", "end": "9:40 AM", "time": "8:40 AM – 9:40 AM"}
            ]
        elif count == 3:
            return [
                {"start": "7:40 AM", "end": "8:40 AM", "time": "7:40 AM – 8:40 AM"},
                {"start": "8:40 AM", "end": "9:40 AM", "time": "8:40 AM – 9:40 AM"},
                {"start": "10:00 AM", "end": "11:00 AM", "time": "10:00 AM – 11:00 AM"}
            ]
        elif count == 4:
            return [
                {"start": "7:40 AM", "end": "8:40 AM", "time": "7:40 AM – 8:40 AM"},
            ...
            return [
                ...
                {"start": "10:00 AM", "end": "11:00 AM", "time": "10:00 AM – 11:00 AM"},
                {"start": "12:40 PM", "end": "1:40 PM", "time": "12:40 PM – 1:40 PM"},
                {"start": "1:40 PM", "end": "2:40 PM", "time": "1:40 PM – 2:40 PM"}
            ]
...
def get_odl1_slots(sec, count, opt=0):
    ...
    if g in ['Grade 11', 'Grade 12']:
        if count == 1:
            ...
            return [
                {"start": "12:40 PM", "end": "1:40 PM", "time": "12:40 PM – 1:40 PM"},
                {"start": "1:50 PM", "end": "2:50 PM", "time": "1:50 PM – 2:50 PM"},
                {"start": "3:10 PM", "end": "4:10 PM", "time": "3:10 PM – 4:10 PM"}
            ]
    elif g == 'Kinder 2':
        if count == 1:
    ...
    else: # Grades 1-10 ODL 1st Shift
        if count == 1:
            return [{"start": "12:40 PM", "end": "1:40 PM", "time": "12:40 PM – 1:40 PM"}]
        elif count == 2:
            return [
            ...
            return [
                {"start": "12:40 PM", "end": "1:40 PM", "time": "12:40 PM – 1:40 PM"},
                {"start": "1:45 PM", "end": "2:45 PM", "time": "1:45 PM – 2:45 PM"},
                {"start": "2:45 PM", "end": "3:45 PM", "time": "2:45 PM – 3:45 PM"}
            ]
...
def get_odl2_slots(sec, count, opt=0):
    ...
    if g == 'Grade 11':
        if count == 1:
            return [{"start": "3:40 PM", "end": "4:40 PM", "time": "3:40 PM – 4:40 PM"}]
        elif count == 2:
            return [
                {"start": "3:40 PM", "end": "4:40 PM", "time": "3:40 PM – 4:40 PM"},
                {"start": "4:50 PM", "end": "5:50 PM", "time": "4:50 PM – 5:50 PM"}
            ]
        else:
            return [
                {"start": "2:20 PM", "end": "3:20 PM", "time": "2:20 PM – 3:20 PM"},
                {"start": "3:40 PM", "end": "4:40 PM", "time": "3:40 PM – 4:40 PM"},
                {"start": "4:50 PM", "end": "5:50 PM", "time": "4:50 PM – 5:50 PM"}
            ]
    elif g == 'Kinder 2':
        if count == 1:
            sl = ["3:40 PM – 4:40 PM", "4:50 PM – 5:50 PM"][opt % 2]
            st, et = sl.split(" – ")
            return [{"start": st, "end": et, "time": sl}]
        else:
            return [
    ...
    else: # Grades 1-10 ODL 2nd Shift
        if count == 1:
            return [{"start": "3:40 PM", "end": "4:40 PM", "time": "3:40 PM – 4:40 PM"}]
        elif count == 2:
            return [
            ...
            return [
                {"start": "3:40 PM", "end": "4:40 PM", "time": "3:40 PM – 4:40 PM"},
                {"start": "4:50 PM", "end": "5:50 PM", "time": "4:50 PM – 5:50 PM"},
                {"start": "5:50 PM", "end": "6:50 PM", "time": "5:50 PM – 6:50 PM"}
            ]
...
def solve_group_coordinated(group_name, group_secs, get_slots_fn, global_teacher_busy):
    ...
    grade_order = ['Kinder 1', 'Kinder 2', 'Grade 1', 'Grade 2', 'Grade 7', 'Grade 8', 'Grade 9', 'Grade 10', 'Grade 11', 'Grade 12', 'Grade 3', 'Grade 4', 'Grade 5', 'Grade 6', 'Grade 7 & 8', 'Grade 9 & 10']
    
    items = []
    for g_name in grade_order:
        if g_name in grade_buckets:
    ...
    for attempt in range(50000):
        ...
        for s_data, sec_order in items:
            ...
            offset = (sec_order * 3 + attempt * 2) % len(shuffled_subs)
                    ...
                    for t in cands:
                        ...
                        for (t_st, t_et) in local_teacher_busy[(t, d_date)]:
                            if max(st_m, t_st) < min(et_m, t_et):
                                ...
                                break
                        if not has_overlap:
                            valid_options.append((len(local_teacher_busy[(t, d_date)]), ts_idx, d_date, day_info, sl, t, st_m, et_m))
